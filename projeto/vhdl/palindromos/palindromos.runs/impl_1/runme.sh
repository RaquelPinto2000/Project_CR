...
HD_PWD='C:/Academico/UA/4ano/2semestre/CR/Pratica/Projeto/palindromos/palindromos.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopPalindromo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopPalindromo.tcl -notrace

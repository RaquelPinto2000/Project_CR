...
HD_PWD='C:/Academico/UA/4ano/2semestre/CR/Pratica/Projeto/palindromos/palindromos.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopPalindromo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopPalindromo.tcl

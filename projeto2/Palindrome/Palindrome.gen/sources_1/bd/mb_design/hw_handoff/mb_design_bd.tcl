...
proc create_root_design { parentCell } {
  ...
  # Create instance: CheckCountPalindrome_0, and set properties
  set CheckCountPalindrome_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:CheckCountPalindrome:1.0 CheckCountPalindrome_0 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net CheckCountPalindrome_0_M00_AXIS [get_bd_intf_pins CheckCountPalindrome_0/M00_AXIS] [get_bd_intf_pins microblaze_0/S0_AXIS]
  ...
  connect_bd_intf_net -intf_net microblaze_0_M0_AXIS [get_bd_intf_pins CheckCountPalindrome_0/S00_AXIS] [get_bd_intf_pins microblaze_0/M0_AXIS]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M07_AXI [get_bd_intf_pins CheckCountPalindrome_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M07_AXI]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins CheckCountPalindrome_0/m00_axis_aresetn] [get_bd_pins CheckCountPalindrome_0/s00_axi_aresetn] [get_bd_pins CheckCountPalindrome_0/s00_axis_aresetn] [get_bd_pins axi_gpio_buttons/s_axi_aresetn] [get_bd_pins axi_gpio_displays/s_axi_aresetn] [get_bd_pins axi_gpio_leds/s_axi_aresetn] [get_bd_pins axi_gpio_switches/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins microblaze_0_axi_periph/M08_ARESETN] [get_bd_pins microblaze_0_axi_periph/M09_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs CheckCountPalindrome_0/S00_AXI/S00_AXI_reg] -force
